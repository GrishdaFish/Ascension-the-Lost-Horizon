...
class ModuleList(window_widget.WindowWidget):
    """
    A small module that lists all modules in the list, white are activated grey are deactivated
    can activate and deactivate modules by clicking on them
    Useful for debugging purposes
    Just create an instance of this, activate it and load it into the engine, no other input required
    """
