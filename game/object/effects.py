...
class Effect:
    """ """"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""" """
        When instantiating an effect you need to link it to an item. Once equipped it is activated on the actor.
        ...
        ***    No actor stats should be edited directly in this file!                                          ***
        ...
        An equippable item has an array for effects that are applied/removed @ on_equip / on_unequip
